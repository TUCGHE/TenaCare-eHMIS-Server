...
{
    class CustomDailyLinelistIndicatorReport : ICustomReport
    {
        ...
        public CustomDailyLinelistIndicatorReport(List<string> locations, int startMonth, int endMonth, int yearStart, int yearEnd, int quarterStart, int quarterEnd, int repKind, int repPeriod, bool showNumDenom, bool showTarget)
        {
        ...
        public CustomDailyLinelistIndicatorReport(List<string> locations, DateTime startDate, DateTime endDate, int yearStart, int yearEnd, int repKind, int repPeriod, bool showNumDenom, bool showTarget)
        {           
            _showNumDenom = showNumDenom;
            _showTarget = showTarget;
            ...
            _startDate = Convert.ToDateTime(startDate.ToShortDateString());
            _endDate = Convert.ToDateTime(endDate.ToShortDateString());
            ...
            if (_repPeriod == 2)
            {
                if (_startDate != _endDate)
                {
                    ...
                    while( i <= _endDate)
                    {
                        ...
                        listOfMonths.Add(i.ToShortDateString());
                        i = i.AddDays(1);
                    }
                }
                else
       ...
       //     SqlCommand toExecute = new SqlCommand(cmdQuery);
        ...
        public DataTable CreateReport()
        {
           ...
           /* else if (_repPeriod == 1)
            ...
            SqlCommand toExecute;
            queryTable = "select * from EthEhmis_DailySummaryIndicators  "
                            ...
                            if (readOnly == false)
                            {
                                if (actions.Equals("Completeness"))
                                {
                                      ...
                                      //  DBConnHelper DBConnHelper = new DBConnHelper();
                                        ...
                                        toExecute.Parameters.Add(new SqlParameter("@StartWeek", _startDate));
                                        toExecute.Parameters.Add(new SqlParameter("@EndWeek", _startDate));
                                ...
                                if ((numeratorValue != -1) && (indicatorValue != -1))
                                {
                                    ...
                                    {
                                        indicatorValue = decimal.Round(indicatorValue, 0);
                            ...
                            if (actions.Equals("Completeness"))
                                {
                                    indicatorValue = 0; 
                                      ...
                                      //  DBConnHelper DBConnHelper = new DBConnHelper();
                                        ...
                                        toExecute.Parameters.Add(new SqlParameter("@Year", _startYear));
                                        toExecute.Parameters.Add(new SqlParameter("@StartWeek", _startDate));
                                        toExecute.Parameters.Add(new SqlParameter("@EndWeek", _endDate));
        ...
        private Hashtable getLocationIdLabelIdValue(out Hashtable locationIdMonthLabelValue)
        {
            ...
            foreach (string locationID in locationsToView)
            {
                ...
                if (_repPeriod == 2) // Daily Epidemic Summary
                {
                    monthYearQueryGroup1 = monthYearQueryGroup2 = " where  DateonsetEpidemic  >= @StartDate and DateonsetEpidemic <= @EndDate ";
                }
                ...
                {                   
                    ...
                    {
                        monthYearQueryGroup1 = "	where  DateonsetEpidemic >=@StartDate and DateonsetEpidemic <= @EndDate  and Year = @StartYear";
                        monthYearQueryGroup2 = "  where   DateonsetEpidemic  = @EndMonth and Year = @endYear  ";
                    }
                }
                ...
                string ethDate =  UtilitiesNew.GeneralUtilities.LocaleConfigurationProvider.GetDateDisplayString(_startDate);
                ethDate = ethDate.Substring(ethDate.Length - 4);
                string queryTable = null;
                if (_repKind == 2)
                {
                    queryTable = " select DateonsetEpidemic,LabelID, sum(Value) as Value \n" +
                                        " from v_EthEhmis_DailyEpidemicSummary" + monthYearQueryGroup1 +
                        //" and (labelId != 4492 and labelId != 4493) \n" +
                                        idQuery + " group by LabelID, DateonsetEpidemic \n";
                }
                else if (_repKind == 4)
                {
                    queryTable = "select sum(\"M<5years\") as 'M<5years' , sum(\"F<5years\") as 'F<5years' , sum(\"M5-14years\") as 'M5-14years', sum(\"F5-14years\") as 'F5-14years', sum(\"M15-44years\") as 'M15-44years'," +
                                  "sum(\"F15-44years\") as 'F15-44years', sum(\"M45+years\") as 'M45+years' , sum(\"F45+years\") as 'F45+years', labelid from eth_PHEMDailyEpidemic " +
                                  monthYearQueryGroup1 + idQuery + "group by Labelid";
                }
                ...
                toExecute.Parameters.AddWithValue("StartDate", _startDate);
                toExecute.Parameters.AddWithValue("EndDate", _endDate);
                ...
                Hashtable Age4M = new Hashtable();
                Hashtable Age4F = new Hashtable();
                Hashtable Age5M = new Hashtable();
                Hashtable Age5F = new Hashtable();
                Hashtable Age15M = new Hashtable();
                Hashtable Age15F = new Hashtable();
                Hashtable Age45M = new Hashtable();
                Hashtable Age45F = new Hashtable();
                ...
                foreach (DataRow row in dt1.Rows)
                {
                   if(_repKind == 2)
                   {
                    dataEleClass = Convert.ToString(30);
                    labelId = row["LabelID"].ToString();
                    hmisValue = row["Value"].ToString();
                    monthValue = Convert.ToDateTime(row["DateonsetEpidemic"].ToString()).ToShortDateString();
        ...
        private decimal sumLabelIds(string locationId, Hashtable locationLabelIdValue, Hashtable locationMonthLabelIdValue, string numeratorLabelid,
            ...
            out decimal numMonthValue, out decimal denomMonthValue, string monthNum)
        {
