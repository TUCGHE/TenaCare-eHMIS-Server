...
namespace eHMISWebApi.Models
{
    ...
    public partial class EthioHIMS_QuarterIPDDiseaseView
    {
        ...
        public Nullable<int> MM04 { get; set; }
        public Nullable<int> MM514 { get; set; }
        public Nullable<int> MM15 { get; set; }
        public Nullable<int> MF04 { get; set; }
        public Nullable<int> MF514 { get; set; }
        public Nullable<int> MF15 { get; set; }
